...
export function SidebarFilters({
  ...
  const [priceMin, setPriceMin] = useState(""); // Armazena o valor em centavos como string
  const [priceMax, setPriceMax] = useState(""); // Armazena o valor em centavos como string
  ...
  useEffect(() => {
    const newFilter: ProductFilter = {
      ...
      onSale: onSale === "yes" ? true : undefined,
